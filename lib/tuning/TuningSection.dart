...
class TuningSection extends StatelessWidget {
  ...
  final TextStyle titleStyle = const TextStyle(fontSize: 25, color: Colors.white, fontWeight: FontWeight.bold);
  @override
        ...
        child: Padding(
            ...
            child:
              ...
              SizedBox(
                  ...
                  child: SingleChildScrollView(child: Column(children: settingsElements))),
