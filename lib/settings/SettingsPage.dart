import 'package:bluetooth_bms/settings/LoadingBadge.dart';
  ...
  Widget build(BuildContext context) {
    Map<int, Widget> tilesMap = {
      0: SettingsSection(key: UniqueKey(), title: "General", settingsElements: [
        OneInputField(
            text: "Number of Cells", initialValue: Data.cell_cnt, onChange: (v) => (widget.registerWrites[Data.CELL_CNT] = v)),
        NtcInputfield(text: "Activated Temperatue Sensors", onChange: (v) => widget.registerWrites[Data.NTC_EN] = v) //TODO
      ]),
      1: SettingsSection(key: UniqueKey(), title: "Capacity Configuration", settingsElements: [
        ...
        OneInputField(
            ...
            onChange: (v) => (widget.registerWrites[Data.CELL_FULL_MV] = v)),
        OneInputField(
      ...
      2: SettingsSection(key: UniqueKey(), title: "Ballancer Configuration", settingsElements: [
        ...
        SwitchField(value: false, text: "Balancer Enabled", onChange: (v) => widget.registerWrites[Data.FUNCTION] = v), //TODO
        SwitchField(
            value: true, text: "Balance only while charging", onChange: (v) => widget.registerWrites[Data.FUNCTION] = v) //TODO
      ]),
      3: SettingsSection(key: UniqueKey(), title: "Function Configuration", settingsElements: [
        OneInputField(
            ...
            onChange: (v) => widget.registerWrites[Data.DEL_FET_CTRL_SW] = v),
        OneInputField(
            text: "LED delay", initialValue: Data.param_del_led, onChange: (v) => widget.registerWrites[Data.DEL_LED] = v)
      ]),
      4: SettingsSection(key: UniqueKey(), title: "Protection", settingsElements: [
        ThreeInputField(
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_C_HIGH_TEMP_TRIG] = v,
            secondOnChange: (v) => widget.registerWrites[Data.PROT_C_HIGH_TEMP_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_HIGH_CH_TEMP] = v,
            firstHeader: "Trigger",
        ...
        ThreeInputField(
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_C_LOW_TEMP_TRIG] = v,
            secondOnChange: (v) => widget.registerWrites[Data.PROT_C_LOW_TEMP_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_LOW_CH_TEMP] = v),
        ThreeInputField(
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_D_HIGH_TEMP_TRIG] = v,
            secondOnChange: (v) => widget.registerWrites[Data.PROT_D_HIGH_TEMP_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_HIGH_D_TEMP] = v),
        ThreeInputField(
            pair: true,
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_D_LOW_TEMP_TRIG] = v,
            secondOnChange: (v) => widget.registerWrites[Data.PROT_D_LOW_TEMP_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_LOW_D_TEMP] = v),
        ThreeInputField(
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_BAT_HIGH_TRIG] = v,
            secondOnChange: (v) => widget.registerWrites[Data.PROT_BAT_HIGH_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_HIGH_BAT_V] = v),
        ThreeInputField(
            pair: true,
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_BAT_LOW_TRIG] = v,
            secondOnChange: (v) => widget.registerWrites[Data.PROT_BAT_LOW_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_LOW_BAT_V] = v),
        ThreeInputField(
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_CELL_HIGH_TRIG] = v,
            secondOnChange: (v) => widget.registerWrites[Data.PROT_CELL_HIGH_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_HIGH_CELL_V] = v),
        ThreeInputField(
            pair: true,
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_CELL_LOW_TRIG] = v,
            secondOnChange: (v) => widget.registerWrites[Data.PROT_CELL_LOW_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_LOW_CELL_V] = v),
        ThreeInputField(
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_CH_HIGH_MA] = v,
            secondOnChange: (v) => widget.registerWrites[Data.DEL_HIGH_MA_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_HIGH_MA] = v),
        ThreeInputField(
            pair: true,
            ...
            firstOnChange: (v) => widget.registerWrites[Data.PROT_D_HIGH_MA] = v,
            secondOnChange: (v) => widget.registerWrites[Data.DEL_LOW_MA_REL] = v,
            thirdOnChange: (v) => widget.registerWrites[Data.DEL_LOW_MA] = v),
      ]),
      5: SettingsSection(key: UniqueKey(), title: "Advanced Protection", settingsElements: [
        TwoInputField(
          text: "OverVoltage II",
          firstOnChange: (v) => widget.registerWrites[Data.CELL_FULL_MV] = v,
          secondOnChange: (v) => widget.registerWrites[Data.CELL_FULL_MV] = v,
          firstHeader: "Trigger",
          secondHeader: "Delay",
        ),
        TwoInputField(
      ...
      children: [
        Container(
            ...
            child: ReorderableListView(
                ...
                children: tiles)),
        if (!Data.availableData) LoadingBadge()
      ],
    );
  }
}
